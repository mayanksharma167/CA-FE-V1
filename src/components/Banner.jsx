...
const InfiniteScrollTestimonials = () => {
  ...
  const TestimonialCard = ({ testimonial }) => (
    <div className="min-w-[280px] sm:min-w-[320px] md:min-w-[400px] p-4 sm:p-6 mx-2 sm:mx-4 bg-gradient-to-br from-gray-800/90 via-gray-900/90 to-black/90 rounded-xl backdrop-blur-sm hover:scale-[1.02] hover:shadow-2xl hover:shadow-emerald-500/20 transition-all">
      ...
      <p className="mt-3 sm:mt-4 text-sm sm:text-base text-gray-300"><i>"{testimonial.comment}"</i></p>
      <div className="mt-3 sm:mt-4 flex justify-between items-center gap-2 sm:gap-4">
        <div className="text-center">
          <span className="text-emerald-400 font-bold text-sm sm:text-base block">{testimonial.metrics.successRate}</span>
          <span className="text-gray-400 text-xs sm:text-sm">Success Rate</span>
        </div>
        <div className="text-center">
          <span className="text-emerald-400 font-bold text-sm sm:text-base block">{testimonial.metrics.interviews}</span>
          <span className="text-gray-400 text-xs sm:text-sm">Interviews</span>
        </div>
        <div className="text-center">
          <span className="text-emerald-400 font-bold text-sm sm:text-base block">{testimonial.metrics.offers}</span>
          <span className="text-gray-400 text-xs sm:text-sm">Offers</span>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative w-full overflow-hidden py-6 sm:py-10">
      {/* Left Gradient Mask */}
      <div className="absolute left-0 top-0 h-full w-16 sm:w-32 bg-gradient-to-r from-gray-950 to-transparent z-10"></div>
      ...
      {/* Right Gradient Mask */}
      <div className="absolute right-0 top-0 h-full w-16 sm:w-32 bg-gradient-to-l from-gray-950 to-transparent z-10"></div>
    </div>
  );
};
const Banner = () => {
